...
//Modifica el objeto con el nombre del archivo PLY dado
void Escena::leePly(char * archivo){
	objetoPly.crear(archivo);
	objetoRevolucion.crear(archivo,4,1);	
