...
int main(int argc, char **argv) {
	...
	if(argc<3){
		...
		std::cout << "Formato:[Lado][ArchivoPLY/ArchivoPerfil]"<<std::endl;
		std::cout << "***************************************"<<std::endl;	
		return -1;
	}
	...
	std::cout << "Tecla '+' - Aumentar numero de divisiones en Revolucion"<<std::endl;
	std::cout << "Tecla '-' - Disminuir numero de divisiones en Revolucion(minimo 4)"<<std::endl;
